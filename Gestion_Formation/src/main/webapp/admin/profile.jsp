            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="users.jsp" aria-expanded="false"><i class="mdi mdi-face"></i><span
                                    class="hide-menu">Utilsateurs</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="roles.jsp" aria-expanded="false"><i class="mdi mdi-border-all"></i><span
