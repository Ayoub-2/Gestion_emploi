         ...
         <div class="page-wrapper">
                  ...
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form class="form-horizontal form-material mx-3" action="./modify" method="post">
                           <input type="hidden" name="action" value="5" >
                           <input type="hidden" id="id_etu" name="id_etu" value="" >
                           <div class="form-group ">
                              <div class="row align-content-between mx-3">
                                 <div class="col-sm-6 p-l-0" >
            ...
            <div class="modal" id="AddFormation">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header p-5 text-center bg-light">
                        <h4 class="modal-title mb-3">Ajouter Formation</h4>
                     </div>
                     <div class="modal-body">
                        <form class="form-horizontal form-material mx-3" action="./add" method="post">
                           <input type="hidden" name="action" value="5_f" >
                           <input type="hidden" id="id_etu" name="id_etu" value="" >
                           ...
                           <div class="form-group">
                              <label class="col-sm-12 ">Formation</label>
                              <div class="col-sm-12">
                                 <select name="id_formation" class="form-select shadow-none form-control-line">
                                    <%
                                       con = (new ConnectionProvider()).getConnection();
                                       preparedStatement = con.prepareStatement("SELECT id,nom FROM formation");
                                       rs = preparedStatement.executeQuery();
                                       while (rs.next()) {
                                       %>
                     ...
                     <table class="my-table-bordred table-bordered col-12">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <%
                                    ...
                                    %>
                                    <i  style="padding-right:0px;font-size:14px" onclick="ModifyItem(<%=ID_et %>)" class="btn material-icons" data-toggle="modal" onclick="Adformation(<%=ID_et %>)" data-target="#AddFormation">ass</i>
                              </td>
                              <td><%= rs.getString(7)%></td>
                              <td class="text-center"><i  style="font-size:20px" onclick="ModifyItem(<%=ID_et %>)" class="btn material-icons" data-toggle="modal" data-target="#UpdateEtu">create</i></td>
                              <td class="text-center"><i  style="font-size:20px"href="javascript:;" onclick="DeleteItem(<%=ID_et %>)" class="btn material-icons" data-toggle="modal" data-target="#DelEtu">delete</i></td>
                           </tr>
                           <%
                              }%>
                           <tr>
                           ...
                           <td>cell</td>
                              <td>
                                 Cell
                                 <i   onclick="ModifyItem()" style="padding-right:0px;" class="btn material-icons" data-toggle="modal" data-target="#AddFormation">add</i>
                              </td>
                             <td>Cell</td>
                              <td class="text-center"><i   style="font-size:20px" onclick="ModifyItem()" class="btn material-icons" data-toggle="modal" data-target="#UpdateEtu">create</i></td>
                              <td class="text-center"><i  style="font-size:20px" href="javascript:;" onclick="DeleteItem()" class="btn material-icons" data-toggle="modal" data-target="#DelEtu">delete</i></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
