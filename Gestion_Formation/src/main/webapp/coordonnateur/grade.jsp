         ...
         <div class="page-wrapper container">
            <div class="page-breadcrumb">
               <div class="row align-items-center">
                  ...
                  <div class="col-7">
                     <div class="text-end">
                        <a href="" class="btn btn-primary mb-4" style="padding: 10px" data-toggle="modal" data-target="#AddGrade">Ajouter un Grade</a>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <table class="my-table-bordred table-bordered col-12">
                        ...
                        <tbody>
                           <%
                              ...
                              preparedStatement = con.prepareStatement("SELECT id, nom FROM grade ");
