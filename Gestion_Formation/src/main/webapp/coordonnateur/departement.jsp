         ...
         <div class="page-wrapper">
            <div class="page-breadcrumb">
               <div class="row align-items-center">
                  <div class="col-5">
                     <h4 class="page-title">Departement</h4>
                  </div>
                  <div class="col-7">
                     <div class="text-end">
                        <a href="" class="btn btn-primary mb-4" style="padding: 10px" data-toggle="modal" data-target="#AddUser">Ajouter un Departement</a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header bg-light">
                        <h4 class="modal-title mb-3">Ajouter Un Departement</h4>
                     </div>
            ...
            <div class="modal" id="UpdateFormation">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header bg-light">
                        <h4 class="modal-title mb-3">Modifier Donn̩es Departement</h4>
                     </div>
                     <div class="modal-body">
                     ...
                     <table class="my-table-bordred table-bordered col-12">
                        <thead>
                           <tr>
                              <th class="col-1">#</th>
                              <th scope="col">Nom</th>
                              <th style="" colspan="2" class="col-1">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><i href=""onclick="ModifyItem(<%=rs.getInt(1) %>)" class="btn material-icons" data-toggle="modal" data-target="#UpdateFormation">create</i></td>
