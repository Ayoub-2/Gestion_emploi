        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="AddStudent.jsp" method="post">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="physic">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="chemy">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="chemy-lab">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="physic-lab">
                                    </div>
                                </div>
